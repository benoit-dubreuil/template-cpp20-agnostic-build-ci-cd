...
def find_conf_build_system_dir(conf_dir: Optional[Path] = None) -> Path:
    ...
    utils.error.utils.try_external_errors.try_manage_strict_path_resolving(path_to_resolve=conf_build_system_dir,
                                                                           external_errors_to_manage={(Exception,): utils.error.core.cls_def.ConfBuildSystemDirNotFoundError})
