...
def print_symlink_to_compiler_export_shell_env_vars_script(target: build_system.build_target.build_target.BuildTarget) -> None:
    ...
    colorized_symlink = colorize_path(path_info=target.export_shell_env_vars_symlink)
