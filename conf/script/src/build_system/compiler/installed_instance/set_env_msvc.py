...
class EnvMSVC(contextlib.AbstractContextManager):
    ...
    def __get_vcvars_dir(self) -> Path:
        vcvars_dir: Path = self.compiler.installation_dir / self.compiler.get_vcvars_dir_relative_to_installation_dir()
    ...
    def __compute_vcvars_arch_batch_filename(self) -> str:
        return self.compiler.get_vcvars_prefix() + str(self.compiler.arch.value) + self.compiler.get_vcvars_extension()
