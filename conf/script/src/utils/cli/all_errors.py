...
ALL_ERRORS_BY_STATUS: Final[dict[utils.error.error_status.ErrorStatus, Type[utils.cli.managed_error.ManagedError]]] = {status: ALL_ERRORS[status] for status in
                                                                                                                       utils.error.error_status.ErrorStatus}
