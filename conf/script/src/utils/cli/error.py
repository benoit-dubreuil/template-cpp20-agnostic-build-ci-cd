...
class SuccessWarning(UserWarning, utils.cli.error_status.EncodedError, utils.format_error.FormattedSuccess, metaclass=utils.cli.error_meta.ErrorMeta):
...
class UnknownParsedArgError(TypeError, utils.cli.error_status.EncodedError, utils.format_error.FormattedError, metaclass=utils.cli.error_meta.ErrorMeta):
...
class EmptyParsedArgError(ValueError, utils.cli.error_status.EncodedError, utils.format_error.FormattedError, metaclass=utils.cli.error_meta.ErrorMeta):
...
class RootDirNotFoundError(FileNotFoundError, utils.cli.error_status.EncodedError, utils.format_error.FormattedError, metaclass=utils.cli.error_meta.ErrorMeta):
...
class BuildDirNotFoundError(FileNotFoundError, utils.cli.error_status.EncodedError, utils.format_error.FormattedError, metaclass=utils.cli.error_meta.ErrorMeta):
